...
//   }
  ...
  async addDynamicChild(
    parent: { appendChild: { (arg0: any): void; (arg0: any): void } },
    elements: any
  ) {
    if (!elements) return;
  ...
  async renderDynamicNodes(props: any, cb: ((arg0: any) => void) | undefined) {
...
//   async nodeWillWrap(props: any) {
//     await this.renderDynamicNodes(props);
//     this.calculateLayout();
//   }

//   onNodeSplit(height: any, clone: { marginTop: number }) {
//     clone.marginTop = 0;
//     this.marginBottom = 0;
//     this.calculateLayout();
//   }

...
class Node {
  ...
  // setDimension(attr: string, value: string) {
  ...
  //   }
  // }
  // setPosition(edge: any, value: string) {
  //   const percent = matchPercent(value);
  ...
  // setPadding(edge: any, value: string) {
  //   const percent = matchPercent(value);
  ...
  // setMargin(edge: any, value: string) {
  //   const percent = matchPercent(value);
  ...
  // setBorder(edge: any, value: string) {

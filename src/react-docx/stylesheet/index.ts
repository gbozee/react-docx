...
const create = (styles: any) => styles;
...
const flatten = (input: any[]) => {
  ...
  const result = input.reduce((acc: { [x: string]: any }, style: any) => {
    if (style) {
...
const resolveMediaQueries = (input: { [x: string]: any }, container: any) => {
...
const resolve = (styles: any, container: any) => {
